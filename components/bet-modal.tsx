							...
							<div className="text-sm space-y-1">
								<p>
									...
									<span className="font-medium">
										{betPreview.data.riskLevel}
									</span>
								</p>
								{betPreview.data.warnings &&
									betPreview.data.warnings.length > 0 && (
										<div>
											<p className="font-medium text-yellow-700">
												Advertencias:
											</p>
											<ul className="list-disc list-inside text-yellow-600">
												{betPreview.data.warnings.map((warning, _index) => (
