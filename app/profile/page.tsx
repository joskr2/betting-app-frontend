...
import { User, Calendar, TrendingUp, Target, Award, DollarSign } from "lucide-react"
...
export default function ProfilePage() {
  ...
  const totalWinnings = mockBets.filter((bet) => bet.status === "Won").reduce((sum, bet) => sum + bet.potentialWin, 0)
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Información de tu cuenta y estadísticas de apuestas</p>
        </div>
          ...
          <div className="lg:col-span-1">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <label className="text-sm text-gray-500">Balance Actual</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Total de Apuestas</CardTitle>
                  <Target className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">{totalBets}</div>
                  <p className="text-xs text-muted-foreground">Apuestas realizadas</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{formatCurrency(user?.totalBetAmount || 0)}</div>
                  <p className="text-xs text-muted-foreground">Monto total en apuestas</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-green-600">{formatCurrency(totalWinnings)}</div>
